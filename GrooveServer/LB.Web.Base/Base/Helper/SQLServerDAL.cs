...
namespace LB.Web.Base.Helper
{
    public class SQLServerDAL
    {
        ...
        /// <param name="strSQL">查询语句</param>
        /// <returns>SQLiteDataReader</returns>
        public static SQLiteDataReader ExecuteReader(string SQLString, params SqlParameter[] cmdParms)
        {
            SQLiteConnection connection = new SQLiteConnection(GetConnectionString);
            SQLiteCommand cmd = new SQLiteCommand();
            try
        ...
        private static void PrepareCommand(SQLiteCommand cmd, SQLiteConnection conn, SQLiteTransaction trans, string cmdText, SqlParameter[] cmdParms)
        {
