...
namespace LB.MI.MI
{
    ...
    public class ChangeItem
    {
        ...
        public ChangeItem(
            ...
            string NewItemName,string NewCustomerName,string NewReceiveName,string NewCalculateName,
            decimal NewPrice,decimal NewAmount,
            long OldItemID, long OldCustomerID, int OldReceiveType, int OldCalculateType,
            string OldItemName, string OldCustomerName, string OldReceiveName, string OldCalculateName,
            decimal OldPrice, decimal OldAmount)
        {
