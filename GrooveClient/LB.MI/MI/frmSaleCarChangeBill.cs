        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ChangeItem changeItem = new ChangeItem(lNewItemID, lNewCustomerID, iNewReceiveType, iNewCalculateType,
                    strNewItemName, strNewCustomerName, strNewReceiveName, strNewCalculateName, decNewPrice, decNewAmount,
                    lOldItemID, lOldCustomerID, iOldReceiveType, iOldCalculateType,
                    strOldItemName, strOldCustomerName, strOldReceiveName, strOldCalculateName, decOldPrice, decOldAmount);
